...
// Use session values first, fallback to known name
$admin_name = $_SESSION['counselor_short_name'] ?? "Cg. Tanita";
$counselor_full_name = $_SESSION['counselor_full_name'] ?? "Tanita Anak Numpang";

// Extra safety
if (empty($counselor_full_name)) {
    $counselor_full_name = "Tanita Anak Numpang";
}
...
// Latest 5 bookings — ONLY for Tanita
...
// Counseling metrics — ONLY for Tanita
...
<head>
    <meta charset="UTF-8">
    <title>KVKaunsel - Utama (Cg. Tanita)</title>
...
<div class="sidebar">
    ...
    <div class="menu-item <?= basename($_SERVER['PHP_SELF']) == 'KVK_Admin_CgTanita_Utama.php' ? 'active' : '' ?>">
        <i class="fas fa-home"></i><span>Laman Utama</span>
    </div>
    <div class="menu-item <?= basename($_SERVER['PHP_SELF']) == 'KVK_Admin_CgTanita_Tempahan.php' ? 'active' : '' ?>"
         onclick="location.href='KVK_Admin_CgTanita_Tempahan.php'">
        <i class="fas fa-book-open-reader"></i><span>Tempahan Pelajar</span>
    </div>
    <div class="menu-item <?= basename($_SERVER['PHP_SELF']) == 'KVK_Admin_CgTanita_Temujanji.php' ? 'active' : '' ?>"
         onclick="location.href='KVK_Admin_CgTanita_Temujanji.php'">
        <i class="fas fa-calendar-check"></i><span>Temujanji</span>
    </div>
    <div class="menu-item <?= basename($_SERVER['PHP_SELF']) == 'KVK_Admin_CgTanita_Laporan.php' ? 'active' : '' ?>"
...
<div class="main">
    ...
    <div class="left-card" onclick="window.location.href='KVK_Admin_CgTanita_Tempahan.php'">
